...
Network::Network() { common_instance = Kcommon::getInstance(); }

Network::~Network() {}

int Network::get_no_nodes() { return number_of_nodes; }

int Network::get_out_degree(uint n) { return out_neighbors[n].size(); }
